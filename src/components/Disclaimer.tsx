  ...
  return (
    <div className={className}>
      <div
        ...
        className="rounded-2xl border border-yellow-200 bg-yellow-50 px-3 py-2 text-[12px] leading-5 text-slate-700 sm:px-4 sm:py-3 sm:text-sm sm:leading-6"
      >
        <p>
          <span className="font-semibold">⚠️ PediaGo</span>  ne remplace pas le jugement clinique.
        </p>
