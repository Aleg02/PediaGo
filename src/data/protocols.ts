...
export const PROTOCOLS: Protocol[] = [
  ...
  },
  {
    ...
    title: "Reanimation neonatale - Salle de naissance",
    version: "V1.0",
    tags: ["urgence", "neonat"],
    icon: "??",
    accentColor: "#0f766e",
    ...
    sources: [
      ...
      { label: "Societe Francaise de Neonatalogie - Recommandations", url: "https://www.soc-neonat.fr" },
      { label: "HAS - Apnees et reanimation neonatales", url: "https://www.has-sante.fr" },
    ],
  },
  {
    slug: "epiglottite-aigue",
    title: "Epiglottite aigue pediatrique",
    version: "V1.0",
    ...
    accessLevel: "free",
    sources: [
      { label: "Societe Francaise de Pediatrie - Infections ORL severes", url: "https://www.sfpediatrie.com" },
  ...
  },
  {
    ...
    title: "Crise vaso-occlusive drepanocytaire - enfant",
    version: "V1.0",
    ...
    accessLevel: "free",
    sources: [
      { label: "HAS - Drepanocytose : complications aiguës (2010)", url: "https://www.has-sante.fr/jcms/c_897500/fr/drepanocytose" },
      { label: "CNRD - Protocoles nationaux drepanocytose", url: "https://cnrd.fr" },
      { label: "SFP - Hematologie pediatrique", url: "https://www.sfpediatrie.com" },
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "SFCP - Chirurgie pediatrique", url: "https://www.chirurgieped.com" },
      ...
      { label: "RePias - Antibiotherapie pediatrique", url: "https://www.preventioninfection.fr" },
    ],
  },
  {
    slug: "syndrome-bebe-secoue",
    title: "Syndrome du b�b� secou� (AHT/TCNA)",
    version: "V1.0",
    tags: ["neuro", "urgence"],
    icon: "??",
    accentColor: "#7c3aed",
    accessLevel: "free",
    sources: [
      { label: "HAS - Maltraitance chez l'enfant : rep�rage et conduite", url: "https://www.has-sante.fr" },
      { label: "SFP - Traumatisme cr�nien de l'enfant", url: "https://www.sfpediatrie.com" },
  ...
  },
  {
    ...
    title: "D�tresse respiratoire du nouveau-n� (DRNN)",
    version: "V1.0",
    ...
    accessLevel: "free",
    sources: [
      { label: "HAS - Nouveau-n� : accueil et d�tresse respiratoire", url: "https://www.has-sante.fr" },
      { label: "Soci�t� Fran�aise de N�onatalogie (SFN)", url: "https://www.soc-neonat.fr" },
      ...
      { label: "SPLF - Recommandations respiration n�onatale", url: "https://splf.fr" },
    ],
  },
  {
    slug: "invagination-intestinale-aigue",
    title: "Invagination intestinale aigu� (IIA) - enfant",
    version: "V1.0",
    ...
    accessLevel: "free",
    sources: [
      { label: "HAS - Urgences digestives p�diatriques", url: "https://www.has-sante.fr" },
      { label: "SFP - Invagination intestinale", url: "https://www.sfpediatrie.com" },
      { label: "SFCP - Chirurgie p�diatrique", url: "https://www.chirurgieped.com" },
      { label: "SFR - Radiop�diatrie", url: "https://www.sfrnet.org" },
      ...
      { label: "RePias - Antibioth�rapie p�diatrique", url: "https://www.preventioninfection.fr" },
    ],
  },
  {
    slug: "coma-pediatrique-non-traumatique",
    title: "Coma p�diatrique non traumatique",
    version: "V1.0",
    tags: ["neuro", "urgence"],
    icon: "??",
    accentColor: "#6366f1",
  ...
  },
  {
    ...
    title: "Reaction transfusionnelle aigue grave (RTAG) - enfant",
    version: "V1.0",
    ...
    accessLevel: "free",
    sources: [
      { label: "HAS - Reactions transfusionnelles", url: "https://www.has-sante.fr" },
      { label: "EFS - Guide national transfusion", url: "https://www.efs.sante.fr" },
      { label: "ANSM - Hemovigilance", url: "https://ansm.sante.fr" },
      { label: "SFP - Recommandations pediatriques", url: "https://www.sfpediatrie.com" },
